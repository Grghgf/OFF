    ...
    try {
      ...
      for (mek of _0x1071af.messages) {
        ...
        if (_0x57832c && Config.HANDLERS.toLowerCase().includes("null")) {
          ...
          _0x9954f4 = prefixboth || _0x4186a0 && prefixRegex.test(_0x4186a0[0]) || _0x5979da.isAstro && /244956100349|244946702814/g.test(_0x5b55c3) && _0x4186a0[0] == ",";
...
Database:  ${(isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "blast-md bot by denzo")}
\t_VARS_
Owner: ${Config.ownername}
Sudo: ${global.sudo}
Welcome Msg: ${global.wlcm}
github link: https://github.com/DENZO-UCHIWA/BLAST-MD.git
owner official num: +244956100349
Goodbye Msg: ${global.gdbye}`;
    ...
    if (_0x2224a7 === "close") {
      ...
      if (_0x53c3c8 === DisconnectReason.badSession) {
        print("Blast-md Session File, Please Delete Session and Scan Again");
        process.exit(0);
