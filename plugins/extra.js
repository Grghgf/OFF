...
smd({
  ...
  try {
    ...
    if (!_0x587b99) {
      return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/DENZO-UCHIWA/BLAST-MD*");
    }
...
let tmpUrl = "https://telegra.ph/file/08f0eaf22ae3a2808b3a9.jpg";
const secmailData = {};
smd({
  pattern: "tempmail",
